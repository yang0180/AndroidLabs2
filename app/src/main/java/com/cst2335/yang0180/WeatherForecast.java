...
public class WeatherForecast extends AppCompatActivity {
    ...
    private class ForecastQuery extends AsyncTask<String, Integer, String> {
        ...
        String uvURL="https://api.openweathermap.org/data/2.5/uvi?appid=7e943c97096a9784391a981c4d878b22&lat=45.348945&lon=-75.759389";
                        ...
                        case START_TAG:         //This is a start tag < ... >
                            ...
                            }else if (tagName.equals("weather"))
                            {
                                ...
                                if(fileExistance(iconName + ".png")){
                                    ...
                                    URL urlImage = new URL("https://openweathermap.org/img/w/" + iconName + ".png");
